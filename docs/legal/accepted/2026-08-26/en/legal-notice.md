...
Greece, P.D. 131/2003) and Article 13 GDPR.

## Provider

- **Legal name:** `[COMPANY LEGAL NAME]`
- **Trading name / product:** Libriant — a CyberSystema product
- **Legal form:** `[e.g. Private Company (IKE) / S.A. (AE)]`
- **Registered address:** `[REGISTERED ADDRESS]`
- **Company registration (GEMI) no.:** `[COMPANY REGISTRATION NUMBER / GEMI]`
- **VAT (ΑΦΜ) / tax office (ΔΟΥ):** `[VAT NUMBER]` / `[TAX OFFICE]`
- **Legal representative(s):** `[NAME(S)]`
...
- **Telephone:** `[PHONE]`
- **Website:** `[WEBSITE URL]`
- **Data-protection / DPO contact:** `[DPO EMAIL]`
...
[Cookie Policy](/legal/cookies) · [Data Processing Agreement](/legal/dpa) ·
[Sub-processors](/legal/subprocessors) · [Acceptable Use Policy](/legal/acceptable-use)
